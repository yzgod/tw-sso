...
<head>
    ...
    <script type="text/javascript" src="<s:static/>/sso/role/org_role.js"></script>
</head>
<body style="width:100%;height:100%;" class="clearBorder">

<!-- 顶部功能条 -->
<div id="header" style="text-align:right;">
    <span class="header-left" style="align-text:left">组织架构树</span>
</div>
...
<div id="header1" style="text-align:right;">
    ...
    <a id="saveOrgRoleBtn" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit"
       onclick="saveOrgRole()">保存角色分配</a>
</div>
<%-- 角色树 --%>
