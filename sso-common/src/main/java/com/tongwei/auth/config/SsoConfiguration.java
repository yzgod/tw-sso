...
//	private static final Logger logger = LoggerFactory.getLogger(SsoConfiguration.class);
    ...
    public FilterRegistrationBean filterRegistration(SsoProperties properties, SsoFilter ssoFilter,
        ...
        registration.addInitParameter("enableMenuPattern",
                String.valueOf(enableMenuPattern || properties.isEnableMenuPattern()));
        registration.addInitParameter("successUrl", properties.getSuccessUrl());
        registration.addInitParameter("enableRememberMe",
                String.valueOf(enableRememberMe || properties.isEnableRememberMe()));
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        if (enableAccessLog) {
            registry.addInterceptor(new AccessLogInterceptor()).addPathPatterns(accessLogUrlPatterns)
