...
public class UserController extends BaseController{
	...
	public Result getAppRoleByUserId(Integer uId){
		...
		for (RegisterApp app : list) {
			...
			List<Role> collect = listRoles.stream().filter(e->appCode.equals(e.getAppCode())).collect(Collectors.toList());
	...
	public Result save(User user,
			Integer mainOrg, String partTimeOrgs,
			Integer mainPosition, String partTimePositions,
			String userGroups
			) throws Exception{
